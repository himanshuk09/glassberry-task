          ...
          <div class="mb-4">
            <div class="mb-6 max-w-3xl text-center sm:text-center md:mx-auto md:mb-12">
              ...
              <p class="mx-auto mt-4 max-w-3xl text-xl text-gray-600 dark:text-slate-400">
                Partner with Infosys for Innovation and Digital Transformation.
              </p>
            </div>
          </div>
            ...
            <div class="grid md:grid-cols-2">
              <div class="h-full pr-6">
                <p class="mt-3 mb-12 text-lg text-gray-600 dark:text-slate-400">
                  ...
                  looking to optimize your operations or implement
                  next-generation technologies, our global teams are ready to
                  collaborate with you. Let's connect and innovate together to
