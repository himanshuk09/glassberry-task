  ...
  return (
    <div className="bg-[url('./images/iga-swiatek-leadimg.jpg')] bg-cover bg-center  min-h-screen flex items-center justify-left lg:pl-36 pl-6">
      ...
      >
        ...
        <button className="relative font-semibold text-white py-2 px-6 border border-white rounded-sm w-32 sm:w-40 hover:bg-white hover:text-white transition-all duration-300 overflow-hidden group">
